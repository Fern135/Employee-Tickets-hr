export class Ajax {
    ...
    setData(data = {}) {
        if (this.utility.isJson(data)) {
            ...
            return console.log(this.utility.jsonify({ 'data': `${data} is not json format` })); // not in json format
        }
    }
    ...
    #getBroswerSupport(){ // getting the browser and using the correct ajax method
